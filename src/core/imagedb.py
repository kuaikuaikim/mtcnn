...
class imagedb(object):
    def __init__(self, train_12_24_48_root_path, image_annotation_file, mode='train'):
        self.root_path = train_12_24_48_root_path
    ...
    def image_path_from_index(self, index):
        ...
        if not os.path.exists(index):
            image_file = os.path.join(self.root_path, index)
        else:
            image_file=index
